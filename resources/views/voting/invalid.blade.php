...
<body
    class="min-h-screen bg-linear-to-br from-slate-50 via-red-50/20 to-slate-100 flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-md text-center">
        <div class="bg-white rounded-3xl shadow-2xl shadow-red-100/50 border border-red-100/60 p-10">
            ...
            <div class="mt-8 p-4 bg-amber-50 rounded-2xl border border-amber-100 text-left flex items-start gap-3">
                <svg class="h-5 w-5 text-amber-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p class="text-sm text-amber-700 font-medium">Please contact the administrator to request a new
                    invitation link.</p>
            </div>
        </div>
