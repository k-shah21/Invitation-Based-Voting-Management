    ...
    <div class="wrapper">
        ...
        <div class="header">
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14 22l6 6 10-12" stroke="white" stroke-width="2.5" stroke-linecap="round"
        ...
        <div class="body">
            ...
            <p class="text">
                You have been invited to participate in a voting session. Please use your secure, unique link below to
                cast your vote. This link is private and should not be shared with anyone.
            </p>
